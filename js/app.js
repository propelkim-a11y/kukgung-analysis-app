    ...
    if (nodes.btnDownloadVideo) {
        nodes.btnDownloadVideo.addEventListener('click', async () => {
            try {
                ...
                const actualMime = await core.loadCache('lastRecordedMime') || 'video/mp4';
